...
date: 2019-11-15
author: Adam B
image: { src: "../../assets/images/headers/cities-splash.png", title: "Splash screen" }
...
![Virtual Cities Brief Slide](../../assets/images/posts/virtual-cities/proj-virtual-cities-brief.png)
...
![Screenshot of Pintrest](../../assets/images/posts/virtual-cities/proj-virtual-cities-pintrest.png)
...
<p style="text-align: center;">
  <i>
    <b>
      Image credit, <Link href="https://janeaustens.house/jane-austens-house-from-home/" text="Chawton Cottage Museum Virtual Tour" />
    </b>
  </i>
</p>

![Fireplace image](../../assets/images/posts/virtual-cities/proj-virtual-cities-where-fit-in.png)
...
![Kettle Smooth](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle1.png)
...
![Kettle Spout](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle3-spout.png)
...
![Kettle Lid](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle4.png)
...
![Kettle Smooth Lid](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle6-lid-smooth.png)
...
![Kettle Subdiv 1](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle5-l.png)
![Kettle Subdiv2](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle5-r.png)

I scaled the lid to fit, then moved it to be in line with the body of the kettle.

![scaled kettle lid](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle7.png)
...
![Applied subdiv to the handle and connectors](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle8.png)
...
![UV unwrap demo - Wikipedia](../../assets/images/posts/virtual-cities/uv-unwrap-demo.png)
...
![Final kettle render](../../assets/images/posts/virtual-cities/proj-virtual-cities-kettle-rendered.png)
...
![](../../assets/images/posts/virtual-cities/proj-virtual-cities-pot1.png)

![](../../assets/images/posts/virtual-cities/proj-virtual-cities-pot2.png)

![](../../assets/images/posts/virtual-cities/proj-virtual-cities-pot3.png)
...
![](../../assets/images/posts/virtual-cities/proj-virtual-cities-pot4.png)
...
![](../../assets/images/posts/virtual-cities/pot-handle-example1.png)

I UV unwrapped the pan, marking the seams as needed.

![](../../assets/images/posts/virtual-cities/pot-uv-example.png)
...
![](../../assets/images/posts/virtual-cities/pot-handle-no-hole.png)
...
<a href="https://www.youtube-nocookie.com/embed/fPqI8AraTCg" target="_new">
  ![](../../assets/images/posts/virtual-cities/pot-handle-thumb.png)
</a>
