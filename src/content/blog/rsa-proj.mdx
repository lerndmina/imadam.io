...
date: 2019-05-22
author: Adam B
image: { src: "../../assets/images/headers/proj-rsa-coldperson.jpg", alt: "A picture of cold person" }
...
<p style="text-align: center;">
  <i>
    <Link href="https://link.lerndmina.dev/cj1gg" text={`Image from Shutterstock "Paramedic rescues an elderly person in distress..."`} />
  </i>
</p>
