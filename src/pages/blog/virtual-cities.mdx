...
date: 2019-11-15
author: Adam B
image: { src: "/assets/images/posts/virtual-cities/splash.png", alt: "Splash screen" }
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-brief.png"} alt={"Virtual Cities Brief Slide"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-pintrest.png"} alt={"Screenshot of Pintrest"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-where-fit-in.png"} alt={"Fireplace image"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle1.png"} alt={"[Kettle Smooth"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle3-spout.png"} alt={"Kettle Spout"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle4.png"} alt={"Kettle Lid"} width={1200} height={600} format={"avif"}/>
![]()
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle6-lid-smooth.png"} alt={"Kettle Smooth Lid"} width={1200} height={600} format={"avif"}/>
![]()
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle5-l.png"} alt={"Kettle Subdiv 1"} width={1200} height={600} format={"avif"}/><Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle5-r.png"} alt={"Kettle Subdiv2"} width={1200} height={600} format={"avif"}/>

I scaled the lid to fit, then moved it to be in line with the body of the kettle.

<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle7.png"} alt={"scaled kettle lid"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle8.png"} alt={"Applied subdiv to the handle and connectors"} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/uv-unwrap-demo.png"} alt={"UV unwrap demo - Wikipedia"} width={1200} height={800} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-kettle-rendered.png"} alt={"Final kettle render"} width={1200} height={900} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-pot1.png"} alt={""} width={1200} height={800} format={"avif"}/>


<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-pot2.png"} alt={""} width={1200} height={800} format={"avif"}/>


<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-pot3.png"} alt={""} width={1200} height={800} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/proj-virtual-cities-pot4.png"} alt={""} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/pot-handle-example1.png"} alt={""} width={1200} height={600} format={"avif"}/>

I UV unwrapped the pan, marking the seams as needed.

<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/pot-uv-example.png"} alt={""} width={1200} height={600} format={"avif"}/>
...
<Image class="sm:px-8 md:px-16 py-10 drop-shadow-lg" src={"/assets/images/posts/virtual-cities/pot-handle-no-hole.png"} alt={""} width={1200} height={600} format={"avif"}/>
...
<a href="https://www.youtube-nocookie.com/embed/fPqI8AraTCg" target="_new"><img src="/assets/images/posts/virtual-cities/pot-handle-thumb.png"/></a>
